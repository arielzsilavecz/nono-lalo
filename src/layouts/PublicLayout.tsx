  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <footer className="border-t border-crema-200 bg-crema-100">
        <div className="mx-auto flex max-w-4xl flex-col items-center px-4 py-0 text-center text-navy-600">
          <p className="font-script text-xl text-navy-600">comidas 100% caseras</p>
          <p className="font-script text-xl text-navy-600">
      ...
      {waNumber && (
        <a
          ...
          className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-xl transition-transform hover:scale-110"
        >
